...
const _BLOCKED_PROVIDER_HOSTS = /^(0\.0\.0\.0|169\.254\.\d+\.\d+|metadata\.google\.internal)$/i;
...
async function _hostedFetch(body) {
  ...
  return fetch(_AI_API, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(signed) });
}
